                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <div class="text-center" href="index.html">
                                    ...
                                    <h3>PENDAFTARAN {{ strtoupper($role[1]->nama) }}</h3>
                                </div>
                                @if ($errors->any())
                                ...
                                <form class="mt-8 mb-8 login-input" action="{{route('regist-teknisi')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="text" required class="form-control input-flat" value="{{ old('jabatan') }}" name="jabatan" placeholder="Posisi" required>
                                    </div>
                                    <div class="form-group">
