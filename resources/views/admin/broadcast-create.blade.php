            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="{{route('store-broadcast')}}" method="POST">
                            {{csrf_field()}}
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"><b>Judul Broadcast</b></label>
                                <div class="col-sm-10">
                                    <input required type="text" value="{{ old('judul') }}" name="judul" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"><b>Isi Broadcast</b></label>
                                <div class="col-sm-10">
                                    <textarea required class="form-control" name="informasi"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                        ...
                                        <div class="form-row">
                                            <div class="col">
                                                <div class="input-group">
                                                    <input required type="text" value="{{ old('tgl_tampil') }}" id="tgl_tampil" name="tgl_tampil" class="form-control datepicker" placeholder="dd MM yyyy">
                                            ...
                                            <div class="col">
                                                <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                                                    <input required type="text" value="{{ old('waktu_tampil') }}" id="waktu_tampil" name="waktu_tampil" class="form-control" placeholder="hh:mm">
                                                    <span class="input-group-append">
                                ...
                                <div class="col-sm-10">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="col">
                                                <div class="input-group">
                                                    <input required type="text" value="{{ old('tgl_selesai') }}" id="tgl_selesai" name="tgl_selesai" class="form-control datepicker" placeholder="dd MM yyyy">
                                                    <span class="input-group-append">
                                                        <span class="input-group-text"><i class="mdi mdi-calendar-check"></i></span>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                                                    <input required type="text" value="{{ old('waktu_selesai') }}" id="waktu_selesai" name="waktu_selesai" class="form-control" placeholder="hh:mm">
                                                    <span class="input-group-append">
                                                        <span class="input-group-text"><i class="fa fa-clock-o"></i></span>
                                                    </span>
                                                </div>
